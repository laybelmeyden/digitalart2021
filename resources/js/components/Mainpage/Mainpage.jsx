    ...
    return (
        <div>
            ...
            <section id="about" className="container">
                ...
                <a href="/assets/files/polozhenie.pdf">
            ...
            <section id="teams" className="container">
                ...
                <div className="team__grid">
                    ...
                    <div className="team__item">
                        <img
                            src="/assets/img/guliyaeva.png"
                            alt="guliyaeva.png"
                        />
                        <p className="title">Гуляева Алёна</p>
                        <p className="pretitle">
                            Аспирант Института высшей нервной деятельности и
                            нейрофизиологии РАН. Заместитель генерального
                            директора Arteo.tech
                        </p>
                    </div>
                </div>
            </section>
